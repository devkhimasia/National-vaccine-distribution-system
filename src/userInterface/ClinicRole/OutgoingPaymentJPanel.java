...
public class OutgoingPaymentJPanel extends javax.swing.JPanel {
    ...
    public OutgoingPaymentJPanel(JPanel userProcessContainer, ClinicOrganization o) {
        initComponents();
    ...
    public void populate() {
        ...
        for(WorkRequest wr: o.getWorkQueue().getWorkRequestList()){
            if(wr instanceof PaymentRequest){
                ...
                if(pr.getStatus()=="Invoice forwarded to site" || pr.getStatus()=="Invoice forwarded to Clinic"){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(s<0){
            ...
            if(wr.getStatus()=="Invoice forwarded to site" ){
            wr.setStatus("Paid to Distributor");}
            else{
