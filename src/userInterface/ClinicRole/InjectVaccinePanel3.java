...
public class InjectVaccinePanel3 extends javax.swing.JPanel {
    ...
    public InjectVaccinePanel3(JPanel userProcessContainer, ClinicOrganization clinicOrganization, CdcEnterprise e, Patient patient) {
    ...
    public void populate() {
        ...
        dtm.setRowCount(0);
        for (Inventory i : clinicOrganization.getInventoryCatalog().getInventoryList()) {
    ...
    public void populateItemList(Inventory i) {
        ...
        for (Inventory inventory : clinicOrganization.getInventoryCatalog().getInventoryList()) {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(97, 25, 460, 127));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 197, -1, 131));
        ...
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(328, 378, -1, -1));
        add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 375, 159, -1));
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(135, 446, 325, -1));
        ...
        add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(578, 459, 96, 61));

        txtprice.setEditable(false);
        add(txtprice, new org.netbeans.lib.awtextra.AbsoluteConstraints(361, 334, 87, -1));

        jLabel4.setText("Price");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(313, 337, 38, -1));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        clinicOrganization.setTotalVaccine(clinicOrganization.getTotalVaccine()+1);
        ...
        if (s < 0) {
            ...
            vd.setClinicName(clinicOrganization);
            vd.setAppliedBy(by);
            vd.setExtra(extra);
            ...
            if (v.getType() == "Federally Funded") {
                ...
                ij.setSender(clinicOrganization);
                ij.setReceiver(e);
                ij.setVd(vd);
                ij.setP(patient);
                ...
                clinicOrganization.getWorkQueue().getWorkRequestList().add(ij);
                System.out.println("1");
            } else if (v.getType() != "Federally Funded") {
                if (patient.getInsurance() == null || new Date().after(patient.getValidTill())) {
                    ...
                    if (coverage > price) {
                        ...
                        clinicOrganization.getWorkQueue().getWorkRequestList().add(ij);
                        patient.setCoverageAmt(patient.getCoverageAmt()-price);
                    } else {
                        ...
                        //clinicOrganization.getWorkQueue().getWorkRequestList().add(ij1);
