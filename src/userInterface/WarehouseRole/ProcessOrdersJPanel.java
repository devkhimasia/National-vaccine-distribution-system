...
public class ProcessOrdersJPanel extends javax.swing.JPanel {
    ...
    public ProcessOrdersJPanel(JPanel userProcessContainer, WarehouseOrganization o, DistributorOrganization distributorOrganization) {
        initComponents();
    ...
    public void populate() {
        ...
        for (WorkRequest wr : o.getWorkQueue().getWorkRequestList()) {
            if (wr instanceof ClinicOrderRequest) {
                ClinicOrderRequest cor = (ClinicOrderRequest) wr;
                if (cor.getStatus() == "Forwarded to Warehouse") {
                    Object row[] = new Object[3];
                    row[0] = cor;
                    row[1] = cor.getOrder();
                    row[2] = cor.getRequestDate();
                    dtm.addRow(row);
                }
            }
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request ID", "Order ID", "Order Date"
            }
        ));
        ...
        gridBagConstraints.insets = new java.awt.Insets(25, 119, 0, 108);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(59, 251, 190, 0);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(24, 292, 0, 0);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (s < 0) {
            ...
            ClinicOrderRequest cor = (ClinicOrderRequest) jTable1.getValueAt(s, 0);
            ViewOrder h = new ViewOrder(userProcessContainer, cor, o, distributorOrganization);
            CardLayout l = (CardLayout) userProcessContainer.getLayout();
            userProcessContainer.add("ViewOrderDis", h);
