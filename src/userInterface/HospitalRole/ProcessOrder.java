...
public class ProcessOrder extends javax.swing.JPanel {
    ...
    Order tempOrder;
    HospitalOrganization ho;

    public ProcessOrder(JPanel userProcessContainer, ClinicOrderRequest cor, HospitalOrganization ho) {
        initComponents();
...
//throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    private void initComponents() {
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(29, 76, 0, 0);
...
public void populateSecondTable(int s) {
        ...
        for (Inventory i : ho.getInventoryCatalog().getInventoryList()) {
...
//                            OrderItem oii = it.next();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (itemp != tempVaccineList.size()) {
            ...
            cor.getOrder().setStatus("Completed");
            Boolean flag = true;
            ClinicOrganization co = (ClinicOrganization) cor.getSender();
             for (OrderItem oi : tempOrder.getOrder()) {
