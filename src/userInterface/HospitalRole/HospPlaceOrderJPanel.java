 ...
 * @author Dev
 */
public class HospPlaceOrderJPanel extends javax.swing.JPanel {
   ...
   // HospitalOrganization parentOrg;
    ...
    HospPlaceOrderJPanel(JPanel userProcessContainer, HospitalOrganization parentOrg, CdcEnterprise e, PhdEnterprise phd) {
        initComponents();
...
//  throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    private void initComponents() {
        ...
        btnBrowse.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        btnBrowse.setText("Browse");
        btnBrowse.setBorder(new javax.swing.border.MatteBorder(null));
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 11, 0, 48);
        ...
        gridBagConstraints.insets = new java.awt.Insets(6, 48, 0, 48);
        add(jScrollPane1, gridBagConstraints);

        btnAddToCart.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        btnAddToCart.setText("Add To Order List");
        btnAddToCart.setBorder(new javax.swing.border.MatteBorder(null));
        ...
        add(btnAddToCart, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(11, 48, 0, 48);
        ...
        add(spnQuantity, gridBagConstraints);
        ...
        add(btnCheckOut, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        ...
        add(txtModify, gridBagConstraints);
        ...
        gridBagConstraints.gridwidth = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(6, 48, 16, 0);
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        order.setStatus("Forwarded to Provider");
        order.setTotalAmount(total);
        ProviderOrganization po = null;
        for(Organization oo : phd.getOrganizationDirectory().getOrganizationList()){
            if(oo instanceof ProviderOrganization){
                po=(ProviderOrganization) oo;
                break;
            }
        }
               ...
               // System.out.println(parentOrg.getName());
                ...
                po.getWorkQueue().getWorkRequestList().add(cor);
...
private void populateCartTable(Order order) {
        ...
        for (OrderItem oi : order.getOrder()) {
            ...
            if(vaccine.getType()!="Federally Funded"){
