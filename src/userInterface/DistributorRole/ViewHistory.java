...
public class ViewHistory extends javax.swing.JPanel {
    ...
    public ViewHistory(JPanel userProcessContainer,  DistributorOrganization o) {
        initComponents();
    ...
    public void populate() {
        ...
        for (WorkRequest w  : o.getWorkQueue().getWorkRequestList()) {
            ...
            DistributorVaccineOrder dvo = (DistributorVaccineOrder)w;
            if(dvo.getStatus()!="Completed"){
            Object row[] = new Object[3];
            row[0] = dvo.getOrder();
            row[1] = dvo.getOrder().getTimestamp();
            row[2] = dvo.getOrder().getStatus();
         //   row[3] = dvo.getOrder().getShippingdate();
            dtm.addRow(row);
            }
            }
        }
