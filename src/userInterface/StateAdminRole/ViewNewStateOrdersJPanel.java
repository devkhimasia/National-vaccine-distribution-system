 ...
 * @author Dev
 */
public class ViewNewStateOrdersJPanel extends javax.swing.JPanel {
   ...
   JPanel userProcessContainer;
    PhdEnterprise e;
    Network n;
    public ViewNewStateOrdersJPanel(JPanel userProcessContainer, Enterprise e, Network n) {
        initComponents();
...
public void populate(){
    ...
    for(WorkRequest w: e.getWorkQueue().getWorkRequestList()){
        if(w instanceof ClinicOrderRequest){
            ...
            if(c.getStatus()=="Forwarded to State Dept"){
    ...
    private void initComponents() {
        ...
        gridBagConstraints.insets = new java.awt.Insets(27, 20, 0, 28);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(35, 157, 208, 0);
        add(jButton1, gridBagConstraints);

        btnApprove.setFont(new java.awt.Font("Trebuchet MS", 0, 12)); // NOI18N
        btnApprove.setText("Forward to CDC");
        ...
        gridBagConstraints.ipady = 22;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        gridBagConstraints.insets = new java.awt.Insets(35, 129, 208, 0);
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        for (int i = 0; i <= tblClinicOrders.getRowCount(); i++) {
            if (tblClinicOrders.isRowSelected(i)) {
               ...
               e.getMasterCatalog().add(cor);
                cor.setStatus("Forwarded to CDC");
                cor.getOrder().setStatus("Forwarded to CDC");
                Enterprise e1 = n.getEnterpriseDirectory().getEnterpriseList().get(0);
                e1.getWorkQueue().getWorkRequestList().add(cor);
                populate();
            }
        }
